...
import bistu.gbg.entity.*;
import bistu.gbg.enums.QuestionEnum;
import bistu.gbg.repository.*;
import bistu.gbg.service.ExamService;
...
//        );
    ...
    public ExamDetailVo getExamDetail(String id) {
        ...
        assert exam != null;
        examDetailVo.setRadioIds(checkEmptyQuestion(exam.getExamQuestionIdsRadio()));
        examDetailVo.setCheckIds(checkEmptyQuestion(exam.getExamQuestionIdsCheck()));
        examDetailVo.setJudgeIds(checkEmptyQuestion(exam.getExamQuestionIdsJudge()));
        return examDetailVo;
    }
    ...
    public ExamRecord judge(String userId, String examId, HashMap<String, List<String>> answersMap) {
        ...
        userService.updateScore(userId, totalScore);
        return examRecord;
    }
    ...
    private String[] checkEmptyQuestion(String ids) {
