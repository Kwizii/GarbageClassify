<template>
  <div class="main">
    ...
    >
      ...
      <a-form-item>
        <a-checkbox v-decorator="['rememberMe']" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);color:rgb(232, 240, 254);">自动登录</a-checkbox>
        <router-link class="register" :to="{ name: 'register' }" style="float: right;text-shadow: 2px 2px 4px rgba(0,0,0,0.8);color:white;">注册账户</router-link>
      </a-form-item>
